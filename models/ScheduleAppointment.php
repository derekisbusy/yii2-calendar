...
use derekisbusy\calendar\models\ScheduleAppointmentQuery;
 ...
 */
class ScheduleAppointment extends \yii\db\ActiveRecord
{
    ...
    {
        return new ScheduleAppointmentQuery(get_called_class());
    }
    ...
    {
        return $this->hasOne(ScheduleAppointmentType::className(), ['id' => 'type_id']);
    }
    ...
    {
        return $this->hasOne(ScheduleAppointmentStatus::className(), ['id' => 'status_id']);
    }
