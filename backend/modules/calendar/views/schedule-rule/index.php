...
$this->title = Yii::t('backend/schedule-rule', 'Schedule Rules');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="schedule-rule-index">
    <div class="page-header">
            <h1><?= Html::encode($this->title) ?></h1>
    </div>

    <p>
        <?php /* echo Html::a(Yii::t('backend/schedule-rule', 'Create {modelClass}', [
...
//            'label', 
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['schedule-rule/view','id' => $model->id,'edit'=>'t']), [
